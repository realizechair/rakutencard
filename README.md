...
- **主な機能**:
  ...
  - 仕訳データの手動編集
  - 店舗別ルール管理（部分一致検索）
  - **店舗別ルールのエクスポート・インポート（JSON形式）** ← NEW!
  - 勘定科目マスタ管理（追加・編集・削除）
...
6. ✅ **店舗別ルールのエクスポート・インポート（JSON形式）** ← NEW!
7. ✅ 勘定科目マスタ管理（追加・編集・削除、システム科目も対応）
8. ✅ 最新ルールで一括更新機能（バッチ処理による高速化）
9. ✅ Excelファイル出力（.xlsx形式、支払月対応）
10. ✅ プログレスバー表示（処理進捗の可視化）
